...
class mainFrame(wx.Frame):
    ...
    def _CreateToolBar(self, d='H'):
        ...
        bmp_open = wx.Bitmap('res/咖啡杯.png', wx.BITMAP_TYPE_ANY)
        bmp_save = wx.Bitmap('res/礼物.png', wx.BITMAP_TYPE_ANY)
        bmp_help = wx.Bitmap('res/聊天.png', wx.BITMAP_TYPE_ANY)
        bmp_about = wx.Bitmap('res/钟表.png', wx.BITMAP_TYPE_ANY)
